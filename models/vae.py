'''This script based on the example VAE script provided by Keras.
 Many thanks to Keras for the example, and the wonderful interface
 Project uses framework suggested by Yang et al (https://arxiv.org/abs/1702.08139)
 I have been inspired by their great work in the field of NLP, and thank them for the many enjoyable hours I have spent reading their papers
 #Reference
